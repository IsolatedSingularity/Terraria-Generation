...
from Engine.constants import (
    ...
    HARDENED_SAND, SANDSTONE, COBWEB, SHIMMER, MUSHROOM_GRASS,
    JUNGLE_GRASS, LIVING_WOOD, LEAF, CLAY, SILT, CHEST, POT,
    LIFE_CRYSTAL, DART_TRAP, BOULDER_TRAP, PYRAMID_BRICK,
    HIVE, MINECART_TRACK, SUNFLOWER, FALLEN_LOG, ALTAR,
    WALL_NONE, WALL_DUNGEON_BLUE, WALL_DUNGEON_GREEN, WALL_DUNGEON_PINK,
