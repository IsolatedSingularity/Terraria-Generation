...
from terraforge.passes import PASS_SPECS
from terraforge.pipeline import PassEvent, generate_world
from terraforge.render import save_generation_gif, save_npz, save_png, summary_json
...
def _parser() -> argparse.ArgumentParser:
    ...
    generate.add_argument("--seed", default="TerraForge")
...
def _generate(args: argparse.Namespace) -> int:
    ...
    if not args.quiet:
        print()
    png_path = args.png or Path("Plots/terraforge_world.png")
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.command == "gui":
        from terraforge.gui import main as gui_main
