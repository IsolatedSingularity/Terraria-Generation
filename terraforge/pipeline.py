"""Deterministic execution of the complete TerraForge pass catalogue."""
...
from terraforge.generation import PASS_HANDLERS, apply_hardmode, final_cleanup
from terraforge.model import GeneratedWorld, PassResult
from terraforge.passes import PASS_SPECS, PassSpec, Phase
...
def generate_world(
    ...
    return TerraForgePipeline().generate(config or WorldConfig(), progress, cancel, snapshot)
