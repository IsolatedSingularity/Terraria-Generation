...
4. **Independent prototype:** TerraExplorer, useful for studying pass-oriented procedural generation and visualization.
5. **Historical fallback:** old decompiled code, explicitly version-pinned.

TerraExplorer is not a source-faithful Python port of Terraria. Its own README says it is an independent educational project inspired by public generation concepts, uses original Python code and art, does not read or write `.wld`, and contains no private game code. Do not use it as the parity oracle.
...
| 6 | TerraExplorer / Terraria-Generation | https://github.com/IsolatedSingularity/Terraria-Generation | Independent Python generator, visualizer, exports, tests | Procedural-generation laboratory and prototype reference | Explicitly not Terraria source parity and does not read/write `.wld` |
...
git clone https://github.com/IsolatedSingularity/Terraria-Generation.git public-code/TerraExplorer
...
git -C public-code/TerraExplorer rev-parse HEAD
git -C historical-reference/Terarria1405 rev-parse HEAD
```

### Phase 2: Run TerraExplorer only as a laboratory

```bash
cd public-code/TerraExplorer
...
- “TerraExplorer is a source-code-faithful Python translation.”
...
- TerraExplorer is correctly labeled independent rather than source-faithful.
